...
public class rhino_chaPickLev04 : MonoBehaviour
{
	//mouse and screen 
	...
	bottunDone_TeamSelLev04 setPosButtonScript;
	...
	void Start ()
	{
		...
		setPosButtonScript = GameObject.Find ("bottunDone").GetComponent<bottunDone_TeamSelLev04>();
