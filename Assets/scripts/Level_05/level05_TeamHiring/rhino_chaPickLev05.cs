...
public class rhino_chaPickLev05 : MonoBehaviour
{
	//mouse and screen 
	...
	bottunDone_TeamSelLev05 setPosButtonScript;
	...
	void Start ()
	{
		...
		setPosButtonScript = GameObject.Find ("bottunDone").GetComponent<bottunDone_TeamSelLev05>();
