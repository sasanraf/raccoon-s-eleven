...
public class bottunDone_TeamSelLev07 : MonoBehaviour {
	...
	rhino_chaPickLev07 rhinoScript;
	monkey_chaPickLev07 monkeyScript;

	void Start () 
	{
		rhinoScript = GameObject.Find ("rhino").GetComponent<rhino_chaPickLev07>();
		monkeyScript = GameObject.Find ("monkey").GetComponent<monkey_chaPickLev07>();
	...
	void OnMouseDown  () 
	{
		...
		{
			Application.LoadLevel("L7_final");
		}
