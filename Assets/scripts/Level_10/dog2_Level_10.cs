...
public class dog2_Level_10 : MonoBehaviour {

	Animator anim;
	
	dogFightDust02 dogFightDustScript;
	...
	void Start ()
	{
		...
		dogFightDustScript = GameObject.Find("dogFightDust02").GetComponent<dogFightDust02>();
	...
	void Update () 
	{
		if (monkey && monkeyScript.monkeyIsInside == true && gorillaScript.gorillaIsInsideZoon2 == false 
		...
		else if (zebra && zebraScript.zebraIsInside == true && gorillaScript.gorillaIsInsideZoon2 == false
		...
		else if (rhino && rhinoScript.rhinoIsInside == true && gorillaScript.gorillaIsInsideZoon2 == false &&
