...
public class gameScore_Level_06 : MonoBehaviour
{
	...
	void Start () 
	{
		...
		zebraScript = GameObject.Find ("zebra").GetComponent<zebra_Level_06>();
		...
		moneyRandomSafebox02 = Random.Range(10000, 15000);
		...
		if (highlightMeercat02 && moneyMeercat02)
		{
			...
			moneyMeercat02.transform.position = new Vector3(moneyMeercat02_x-1,moneyMeercat02_y,0);
