...
public class gameTimer_Level_09 : MonoBehaviour 
{
	...
	gameScore_Level_09 score;

	endResult endResultScript;
	int starsCount;

	timerZebra_Level_09 zebraSafeBoxCheck;

	pigEvil_level_09 pigEvilScript;
	...
	void Update () 
	{
		...
		if (levelTimer <= 1 || !zebra || (!highlightZebMeercat01
		                        ...
		                        && !highlightZebRabbit01 && !highlightZebRabbit02 && !highlightZebRabbit03 && !highlightZebRabbit04 
