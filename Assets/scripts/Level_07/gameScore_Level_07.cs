...
public class gameScore_Level_07 : MonoBehaviour
{
	...
	void Start () 
	{
		...
		moneyRandomMeercat01 = PlayerPrefs.GetInt("moneyRandomMeercat01_level07");
		moneyRandomRabbit01 = PlayerPrefs.GetInt("moneyRandomRabbit01_level07");
		moneyRandomRabbit02 = PlayerPrefs.GetInt("moneyRandomRabbit02_level07");
		moneyRandomRabbit03 = PlayerPrefs.GetInt("moneyRandomRabbit03_level07");
		moneyRandomRabbit04 = PlayerPrefs.GetInt("moneyRandomRabbit04_level07");
		moneyRandomTeller01 = PlayerPrefs.GetInt("moneyRandomTeller01_level07");
		moneyRandomTeller02 = PlayerPrefs.GetInt("moneyRandomTeller02_level07");
		moneyRandomTeller03 = PlayerPrefs.GetInt("moneyRandomTeller03_level07");
		moneyRandomTeller04 = PlayerPrefs.GetInt("moneyRandomTeller04_level07");
		moneyRandomTeller05 = PlayerPrefs.GetInt("moneyRandomTeller05_level07");
		moneyRandomTeller06 = PlayerPrefs.GetInt("moneyRandomTeller06_level07");
		moneyRandomSafebox = PlayerPrefs.GetInt("moneyRandomSafebox_level07");
		moneyRandomSafebox02 =  PlayerPrefs.GetInt("moneyRandomSafebox02_level07");
