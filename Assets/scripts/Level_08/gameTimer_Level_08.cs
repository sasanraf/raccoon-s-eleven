...
public class gameTimer_Level_08 : MonoBehaviour 
{
	...
	gameScore_Level_08 score;

	endResult endResultScript;
	int starsCount;

	timerZebra_Level_08 zebraSafeBoxCheck;

	pigEvil_level_08 pigEvilScript;
	...
	void Start () 
	{
		...
		pigEvilScript = GameObject.Find ("pigEvil").GetComponent<pigEvil_level_08>();

		zebraSafeBoxCheck = GameObject.Find ("timerObjectZebra").GetComponent<timerZebra_Level_08>();
		...
		score = GameObject.Find ("scoreGUItext").GetComponent<gameScore_Level_08>();
