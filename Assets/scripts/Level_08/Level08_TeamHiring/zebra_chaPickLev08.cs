...
public class zebra_chaPickLev08 : MonoBehaviour {
	...
	GameObject zebraInfo;
	
	void Start ()
	{
		zebraInfo = GameObject.Find ("zebraInfo");
	...
	void OnMouseDrag()  		
	{		
		zebraInfo.renderer.enabled = true;
	...
	void OnMouseExit()
	{
		zebraInfo.renderer.enabled = false;
	}
