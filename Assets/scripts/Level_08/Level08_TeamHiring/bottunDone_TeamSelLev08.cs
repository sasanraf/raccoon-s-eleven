...
public class bottunDone_TeamSelLev08 : MonoBehaviour {
	...
	rhino_chaPickLev08 rhinoScript;
	monkey_chaPickLev08 monkeyScript;

	void Start () 
	{

		rhinoScript = GameObject.Find ("rhino").GetComponent<rhino_chaPickLev08>();
		monkeyScript = GameObject.Find ("monkey").GetComponent<monkey_chaPickLev08>();
