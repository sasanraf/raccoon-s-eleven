...
public class bottunDone_TeamSelLev10 : MonoBehaviour {
	...
	rhino_chaPickLev10 rhinoScript;
	monkey_chaPickLev10 monkeyScript;

	void Start () 
	{

		rhinoScript = GameObject.Find ("rhino").GetComponent<rhino_chaPickLev10>();
		monkeyScript = GameObject.Find ("monkey").GetComponent<monkey_chaPickLev10>();
	...
	void OnMouseDown  () 
	{
		...
		{
			Application.LoadLevel("L10_final");
		}
